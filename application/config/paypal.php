 ...
 *
 */
$config['APIUsername'] = $config['Sandbox'] ? 'vaibhav.seller2295_api1.gmail.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? 'E3PUDWT3BHYY5QE5' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'AFcWxV21C7fd0v3bYYYRCpSSRl31AIv1M32l9dQY3idfckq8vd27q7Y5' : 'PRODUCTION_SIGNATURE_GOES_HERE';
 ...
 */
$config['PayFlowUsername'] = $config['Sandbox'] ? 'vaibhav.seller2295_api1.gmail.com' : 'PRODUCTION_USERNAME_GOGES_HERE';
$config['PayFlowPassword'] = $config['Sandbox'] ? 'E3PUDWT3BHYY5QE5' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['PayFlowVendor'] = $config['Sandbox'] ? 'vaibhavpatel' : 'PRODUCTION_VENDOR_GOES_HERE';
